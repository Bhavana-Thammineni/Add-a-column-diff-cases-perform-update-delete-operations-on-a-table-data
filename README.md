# Add-a-column-diff-cases-perform-update-delete-operations-on-a-table-data
1.add a column at last.middle,and first 2.perform update,delete operations on a table data
